...
export default function About(props) {
    return (
        <div className={"container text-"+props.mode} >
            ...
            <p>
            &rarr; I am <strong>Jay Bhanushali</strong> and I have built this simple text utility application as a project while learning <strong><a href="https://reactjs.org" target="_blank" rel="noreferrer" style={{color:"#35c7ff"}}><img src="logo192.png" alt="React_logo" style={{height:"30px"}} />React</a></strong>. It's my first react app :D
            </p>
            <p>
            &rarr; As the main focus was te learn React, I have used Bootstrap for basic layout and styling of the app...
            </p>
